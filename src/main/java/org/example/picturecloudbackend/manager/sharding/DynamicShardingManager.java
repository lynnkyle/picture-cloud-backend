...
//
//    private static final String DATABASE_NAME = "picture-cloud";
//
...
//        String actualDataNodes = tableNames.stream().map(tableName -> String.format("picture-cloud.%s", tableName)).collect(Collectors.joining(","));
//        log.info("动态分表的actual-data-nodes配置:{}", actualDataNodes);
